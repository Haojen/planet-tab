    ...
    <div class="flex flex-col w-screen h-screen">
        ...
        <footer class="flex flex-col justify-center items-center font-bold text-white">
            <div class="flex justify-center items-center">
                ...
                <router-link to="privacy" class="mx-2 border-b-4 border-transparent" :class="routerTargetName === 'policy' && 'border-blue-600'">Privacy Police</router-link>
                <a href="https://github.com/Haojen/planet-tab" class="mx-2 flex justify-center items-center  border-b-4 border-transparent">
                    <span class="mr-1">Project on Github</span>
